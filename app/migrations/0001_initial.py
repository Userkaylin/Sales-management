    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_purchases', models.DecimalField(decimal_places=2, max_digits=15)),
                ('profit_or_loss', models.DecimalField(decimal_places=2, max_digits=15)),
                ('outlet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.outlet')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('role', models.CharField(choices=[('worker', 'Worker'), ('management', 'Management')], max_length=10)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('outlet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.outlet')),
            ],
            options={
                'verbose_name': 'user',
